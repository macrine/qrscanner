...
#define RETICLE_WIDTH    0.4f
#define RETICLE_OFFSET   80.0f
#define RETICLE_ALPHA     1.0f
#define CORNER_SIZE     24.0f
#define CORNER_WIDTH     4.0f
...
//        //alpha area
//        UIColor* colorBg = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.4];
...
//        
        ...
        UIColor* colorCorner = [UIColor colorWithRed:0.1 green:0.67 blue:0.09 alpha:1];
        CGContextSetStrokeColorWithColor(context, colorCorner.CGColor);
        CGContextSetLineWidth(context, CORNER_WIDTH);
        CGContextBeginPath(context);
//        CGFloat lineOffset = (CGFloat) (RETICLE_OFFSET+(0.5*RETICLE_WIDTH));
        
        CGContextMoveToPoint(context, RETICLE_OFFSET, RETICLE_OFFSET+CORNER_SIZE);
        CGContextAddLineToPoint(context, RETICLE_OFFSET, RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_OFFSET+CORNER_SIZE, RETICLE_OFFSET);
        
        CGContextMoveToPoint(context, RETICLE_SIZE-RETICLE_OFFSET-CORNER_SIZE, RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_SIZE-RETICLE_OFFSET, RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_SIZE-RETICLE_OFFSET, RETICLE_OFFSET+CORNER_SIZE);
        
        CGContextMoveToPoint(context, RETICLE_SIZE-RETICLE_OFFSET, RETICLE_SIZE-RETICLE_OFFSET-CORNER_SIZE);
        CGContextAddLineToPoint(context, RETICLE_SIZE-RETICLE_OFFSET, RETICLE_SIZE-RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_SIZE-RETICLE_OFFSET-CORNER_SIZE, RETICLE_SIZE-RETICLE_OFFSET);
        
        CGContextMoveToPoint(context, RETICLE_OFFSET+CORNER_SIZE, RETICLE_SIZE-RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_OFFSET, RETICLE_SIZE-RETICLE_OFFSET);
        CGContextAddLineToPoint(context, RETICLE_OFFSET, RETICLE_SIZE-RETICLE_OFFSET-CORNER_SIZE);
